...
# Script to upload batch_01 in subbatches of 100 directories each
# This works around GitHub HTTP 500 errors for large uploads
...
print_status "Will create subbatches of $SUBBATCH_SIZE directories each"
...
echo
read -p "Continue with subbatch upload? (y/n): " -n 1 -r
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
...
for ((i=0; i<TOTAL_SUBBATCHES; i++)); do
    SUBBATCH_NUM=$((i + 1))
...
# Final summary
print_success "All subbatches completed!"
print_success "Total subbatches: $TOTAL_SUBBATCHES"
...
echo
echo "==================== SUBBATCH UPLOAD SUMMARY ===================="
echo "✅ batch_01 directories: $TOTAL_DIRS"
echo "✅ Subbatches created: $TOTAL_SUBBATCHES"
echo "✅ Directories per subbatch: $SUBBATCH_SIZE (except last)"
echo "✅ All subbatches pushed to GitHub"
echo "=================================================================" 